...
#End Region
    ...
    Private Sub delCutSheet(ByVal inInvNo As String)
        ...
        For i = 0 To rowCnt - 1
            ...
            Dim sqlDel1 = "DELETE * from CutItem " & _
            ...
            Dim sqlDel2 = "DELETE * FROM SchedItem " & _
        ...
        Dim sqlDel3 = "DELETE * from CuttingSheet " & _
    ...
    Public Sub populate_invoiceNumbers()
        ...
        Dim sql = "SELECT InvoiceNo,InvoiceType,InvDate,InvoiceHeading,InvJobNo FROM Invoice ORDER BY InvoiceNo"
    ...
    Private Sub deleteInvoice(ByVal num As String, ByVal type As String)
        Dim command As OleDb.OleDbCommand = New OleDb.OleDbCommand
        Dim sql = "DELETE * FROM InvoiceLine WHERE InvNo = " & num
